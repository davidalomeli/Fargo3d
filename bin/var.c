...
void InitVariables() {
  ...
  init_var("NINTERM", (char*)&NINTERM, INT, NO, "500");
  init_var("NOISE", (char*)&NOISE, REAL, NO, "0.0");
  init_var("NSNAP", (char*)&NSNAP, INT, NO, "0");
  init_var("NTOT", (char*)&NTOT, INT, NO, "50000");
  ...
  init_var("OUTPUTDIR", (char*)&OUTPUTDIR, STRING, NO, "/project/phys-k/fargo_share/fargo_dustydisk_alldamp_viscr_hires4");
  ...
  init_var("TAUDAMP", (char*)&TAUDAMP, REAL, NO, "0.1");
